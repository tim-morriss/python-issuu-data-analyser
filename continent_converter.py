...
# adapted from https://github.com/jefftune/pycountry-convert/blob/master/pycountry_convert/country_alpha2_to_continent.py
"""
...
def convert_country_alpha2_to_continent(country_2_code):
    ...
    if country_2_code not in COUNTRY_ALPHA2_TO_CONTINENT:
        raise KeyError("%s is not in the list of valid countries" % country_2_code)
